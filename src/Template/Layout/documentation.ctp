...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <?php echo $this->Html->css('DejwCake/AdminLTE./bootstrap/css/bootstrap'); ?>
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    <!-- Theme style -->
    <?php echo $this->Html->css('DejwCake/AdminLTE.AdminLTE.min'); ?>
    <?php echo $this->Html->css('DejwCake/AdminLTE.skins/skin-blue'); ?>
    <?php echo $this->Html->css('DejwCake/AdminLTE.documentation'); ?>
  ...
  <body class="skin-blue fixed" data-spy="scroll" data-target="#scrollspy">
    ...
    <!-- jQuery 2.1.4 -->
    <?php echo $this->Html->script('DejwCake/AdminLTE./plugins/jQuery/jQuery-2.1.4.min'); ?>
    <!-- Bootstrap 3.3.5 -->
    <?php echo $this->Html->script('DejwCake/AdminLTE./bootstrap/js/bootstrap'); ?>
    <!-- SlimScroll -->
    <?php echo $this->Html->script('DejwCake/AdminLTE./plugins/slimScroll/jquery.slimscroll.min'); ?>
    <!-- FastClick -->
    <?php echo $this->Html->script('DejwCake/AdminLTE./plugins/fastclick/fastclick'); ?>
    <!-- AdminLTE App -->
    <?php echo $this->Html->script('DejwCake/AdminLTE.AdminLTE.min'); ?>
    <!-- AdminLTE for demo purposes -->
    <?php echo $this->fetch('script'); ?>
    <?php echo $this->fetch('scriptBottom'); ?>
    <?php echo $this->Html->script('https://google-code-prettify.googlecode.com/svn/loader/run_prettify.js'); ?>
    <?php echo $this->Html->script('DejwCake/AdminLTE.documentation'); ?>
  </body>
</html>
